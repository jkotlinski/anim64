...
AS	= ca65 --cpu 6502x # -l
LD	= ld65 -vm -C anim64.cfg -m anim64.map -Ln anim64.lbl 
C1541  	= ~/bin/c1541
DEPDIR = .dep
...
OBJS = main.o music.o movie.o rle.o rlepack.o rleunpack.o player.o irq.o disk.o loops.o anim.o convert.o screen.o anim_play.o edit.o
