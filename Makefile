...
OBJS = main.o music.o movie.o rle.o rlepack.o rleunpack.o player.o irq.o disk.o loops.o anim.o convert.o screen.o anim_play.o edit.o onefiler.o cbm_dir.o
